...
- Monthly: Security Team/GRC governance checkpoint with DPO visibility.
- T-14 days to expiry: automatic escalation to exception owner, Security Team, and business sponsor.

## Approval
- Business Owner (UK Salesforce): `____________________`
- SST Validation: `____________________`
- Security Team Risk Authority Approval: `____________________`
