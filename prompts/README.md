...
Run a full OSCAL/SSCF assessment and generate both the app-owner deliverable and the Security Team gap matrix.
...
Produce: app-owner DOCX, Security Team gap matrix MD, and NIST review section.
